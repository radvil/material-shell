...
export class DagreNodesLayout implements Layout {
  ...
  public updateEdge(graph: Graph, edge: Edge): Graph {
    ...
    const rankAxis: 'x' | 'y' =
      this.settings.orientation === 'BT' || this.settings.orientation === 'TB' ? 'y' : 'x';
    ...
    if (
      ...
      const startingPoint = {
        ...
        [rankAxis]:
          sourceNode.position[rankAxis] - dir * (sourceNode.dimension[rankDimension] / 2),
      };
      const endingPoint = {
        [orderAxis]: targetNode.position[orderAxis],
        [rankAxis]:
          targetNode.position[rankAxis] + dir * (targetNode.dimension[rankDimension] / 2),
      };
